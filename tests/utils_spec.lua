...
assert(utils.supported_filetype("test.hbs") == "hbs", "should return `hbs`")
assert(utils.supported_filetype("test.handlebars") == "hbs", "should return `hbs`")
assert(utils.supported_filetype("test.ejs") == "ejs", "should return `ejs`")
...
assert(utils.supported_filetype("test/test.hbs") == "hbs", "should return `hbs`")
assert(utils.supported_filetype("test/test.handlebars") == "hbs", "should return `hbs`")
assert(utils.supported_filetype("test/test.ejs") == "ejs", "should return `ejs`")
